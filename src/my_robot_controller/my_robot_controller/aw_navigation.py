...
class CarNavigationNode(Node):
    ...
    def __init__(self):
        ...
        initial_pose.pose.pose.position.x = 3715.54
        initial_pose.pose.pose.position.y = 73696.84
        ...
        self.goal_poses.append({'x': 3628.07, 'y': 73665.43, 'xx': 0.0,'yy': 0.0,'zz': 0.72,'w':0.69})
        self.goal_poses.append({'x': 3748.15, 'y': 73772.54, 'xx': 0.0,'yy': 0.0,'zz': 0.85,'w':0.51})
        self.goal_poses.append({'x': 3741.03, 'y': 73683.29, 'xx': 0.0,'yy': 0.0,'zz': 0.28,'w':0.96})
